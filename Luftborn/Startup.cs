...
namespace Luftborn
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            Bootstrapper.ResolveTokenInfo(services, Configuration);
           //Bootstrapper.ResolveTokenGenerator(services, Configuration);
            ...
            Data.Auth.EntityService.Bootstrapper.ResolveEntityService(services);
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Lean", Version = "v1" });
